...
<%
	...
	session.setAttribute("prevPage", "GalleryCupcakesServlet?albumId=" + photos.get(0).getAlbumId());	
%>
<div class="wrapper">
	<div id="header">
		<div>
	...
	<div id="content-aux">
		<div id="loading"></div>
	    <div class="title-img"><a href="GalleryServlet"> <img src="images/return.png"> </a> Cupcakes </div>
		<% 	if (photos.size() > 0){ %>
